...
[<assembly: AssemblyTitleAttribute("FirstTask.Tests")>]
[<assembly: AssemblyProductAttribute("FirstTask")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "FirstTask.Tests"
    let [<Literal>] AssemblyProduct = "FirstTask"
